...
class Camera(abc.ABC):
    ...
    def get_color_image(self) -> NDArray[(_HEIGHT, _WIDTH, 3), np.uint8]:
        """
    ...
    @abc.abstractmethod
    def get_color_image_no_copy(self) -> NDArray[(_HEIGHT, _WIDTH, 3), np.uint8]:
        """
    ...
    @abc.abstractmethod
    def get_color_image_async(self) -> NDArray[(_HEIGHT, _WIDTH, 3), np.uint8]:
        """
    ...
    @abc.abstractmethod
    def get_depth_image(self) -> NDArray[(_HEIGHT, _WIDTH), np.float32]:
        """
    ...
    @abc.abstractmethod
    def get_depth_image_async(self) -> NDArray[(_HEIGHT, _WIDTH), np.float32]:
        """
